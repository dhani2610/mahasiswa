                ...
                <div class="row align-items-center justify-content-center">
                  <div class="col-md-6">
                    ...
                    <form class="mt-2 pt-2" method="POST" action="{{ route('loginPost2') }}">
                        ...
                        <input type="hidden" name="from" value="{{ Request::get('req') }}">

                        <div class="form-floating form-floating-custom mb-4">
                            <input id="username" type="text" class="form-control  @error('niusernamep') is-invalid @enderror" name="username" value="{{ old('username') }}" required autofocus placeholder="Enter Nip Or Nim">
