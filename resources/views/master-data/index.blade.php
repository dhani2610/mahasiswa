...
@section('style')
   <style>
       ...
       .master-data:hover {
            box-shadow: 0px 0px 33px -14px #ff9100;
       ...
       .info-box {
            box-shadow: 0 0 1px #ff9100, 0 1px 3px #ff9100;
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12 p-1" onclick="location.href='{{ route('departements.index') }}';">
                <div class="info-box bg-gradient-info master-data">
                    <span class="info-box-icon" style="background-color:#ff9100; "><i class="fas fa-building text-white"></i></span>
            ...
            <div class="col-md-4 col-sm-6 col-12 p-1" onclick="location.href='{{ route('users.index') }}';">
                <div class="info-box bg-gradient-info master-data">
                    <span class="info-box-icon" style="background-color:#ff9100; "><i class="fas fa-user text-white"></i></span>
